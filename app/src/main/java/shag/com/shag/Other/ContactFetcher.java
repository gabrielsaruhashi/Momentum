...
public class ContactFetcher {
    ...
    public ArrayList<PhoneContact> fetchAll() {
        ...
        final Map<String, PhoneContact> contactsMap = new HashMap<>(c.getCount());
        ...
        if (c.moveToFirst()) {
            ...
            do {
                ...
                PhoneContact contact = new PhoneContact(contactId, contactDisplayName);
    ...
    public void matchContactNumbers(Map<String, PhoneContact> contactsMap) {
        // Get numbers
    ...
    public void matchContactEmails(Map<String, PhoneContact> contactsMap) {
        // Get email
